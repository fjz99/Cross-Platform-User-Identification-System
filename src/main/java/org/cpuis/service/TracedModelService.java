...
import org.cpuis.entity.*;
import org.cpuis.entity.exception.CpuisException;
import org.cpuis.entity.vo.ModelLocationVO;
import org.cpuis.entity.vo.ModelSearchVO;
import org.cpuis.entity.vo.ModelVO;
import org.cpuis.entity.vo.PredictVO;
...
public class TracedModelService {
    ...
    public PageEntity<ModelVO> query(ModelSearchVO searchVO) {
        ...
        String key = ModelKeyGenerator.generateModelInfoKey (searchVO.getDataset (), searchVO.getAlgoName (),
                searchVO.getPhase (), null, PythonScriptRunner.modelInfoPrefix);
...
//        map.put ("input", input);
    ...
    public int getLatestId(String name, String[] dataset, String phase) {
        String key = ModelKeyGenerator.generateModelInfoKey (dataset, name,
                phase, null, PythonScriptRunner.modelInfoPrefix);
    ...
    public boolean delete(ModelLocationVO vo) {
        String key = ModelKeyGenerator.generateModelInfoKey (vo.getDataset (), vo.getAlgoName (),
                vo.getPhase (), null, PythonScriptRunner.modelInfoPrefix);
    ...
    public boolean contains(String algoName, String[] dataset, String phase, Integer id) {
        String key = ModelKeyGenerator.generateModelInfoKey (dataset, algoName, phase, null, PythonScriptRunner.modelInfoPrefix);
